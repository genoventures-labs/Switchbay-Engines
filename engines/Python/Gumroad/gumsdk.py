...
class GumroadSDK:
    ...
    def get_sales_summary(self) -> Dict[str, Any]:
        """Get a summary of sales, including total sales and total revenue.
        Note: Gumroad does not expose a public refund list endpoint, so refund
        counts are omitted to avoid 404 errors."""
        all_sales = self.list_all_sales()
